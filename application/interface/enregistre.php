...
$d="select * from admin_svg.col_sel where idtheme='".$cou[$l]['idtheme']."'";
	...
	$f.=" where 1=1";
		...
		elseif (substr($_SESSION['profil']->insee, -3) == "000" || $cou[$l]['schema']=="bd_topo"){
...
$countlayer=$countlayer+1;
	...
	if($type_geo=="symbole")
				...
				for ($e=0;$e<count($res);$e++)
					...
					$textq="<use transform=\"matrix(".(round($cou[$l]['font_size']/2.4)/1000)." 0 0 -".(round($cou[$l]['font_size']/2.4)/1000)." ".$coorx." ".$coory.")\" xlink:href=\"#".$cou[$l]['symbole']."\" />";
					//$textq="<text ".$res[$e]['geom']." style=\"font-family:svg\">".$cou[$l]['symbole']."</text>\n";
					fputs($myFile, $textq);
					}
					$legend.="<use transform=\"matrix(0.007 0 0 -0.007 -150 ".$ylegend.")\" xlink:href=\"#".$cou[$l]['symbole']."\" style=\"".$fill_legend.$strok_legend.$opa_legend."\"/>";
...
$data=$cota.$str3.$str4.$legend."</g></svg>";
fputs($myFile, $data);
fclose($myFile);
$ch_image="";
