...
if(	$rast=='postit')
{
$textq.="<g id=\"".$_GET['layer']."\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" taille=\"24\" surcoul=\"blue\" lie=\"lien(evt,'postit',protocol+'://'+serveur+'/interface/postit.php?obj_keys=','','')\" attribu=\"symbole\" ";
...
if($cou[0]['mouseover']!=''||$cou[0]['click']!='')
{
	if($type_geo=="symbole")
				{
				$textq="<g id=\"".$_GET['layer']."\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" taille=\"".$cou[0]['font_size']."\" surcoul=\"blue\" lie=\"".$cou[0]['click']."\" attribu=\"symbole\" ";
				$rot='';
...
{	
	if($type_geo=="symbole")
				{
				$textq="<g id=\"".$_GET['layer']."\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" taille=\"".$cou[0]['font_size']."\" surcoul=\"blue\" lie=\"\" attribu=\"symbole\" ";
				$rot="";
				for ($e=0;$e<count($res);$e++)
					{
					if($res[$e]['geom']!="")
